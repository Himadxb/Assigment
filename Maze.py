...
if __name__ == "__main__":
    grid = [
        [ WALL,  WALL,  WALL,  WALL,  WALL,  WALL,  EMPTY,  WALL,  WALL, WALL],
        [START, EMPTY,  WALL,  WALL, EMPTY, WALL, EMPTY, EMPTY,  WALL, WALL],
        [ EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,  WALL, EMPTY,  WALL, WALL],
        [ WALL,  WALL,  EMPTY,  WALL, WALL,  WALL, EMPTY,  WALL, EMPTY, WALL],
        [ WALL, EMPTY, WALL, WALL, EMPTY,  WALL, EMPTY, EMPTY, EMPTY, WALL],
        [ WALL,  WALL, EMPTY,  EMPTY,  WALL, EMPTY, WALL,  WALL, EMPTY, WALL],
        [ WALL,  EMPTY, EMPTY, EMPTY, EMPTY, WALL,  WALL,  WALL, EMPTY,  END],
...
GridViewer.view(grid)
    ...
    while not done and charIndex < solutionLength:
        ...
        if (currentRow < 0 or currentCol < 0 
            ...
            if grid[currentRow][currentCol] == EMPTY:
                ...
                print("You stumble blindly into a concrete wall.") # Hit wall.

            elif grid[currentRow][currentCol] == END:
                done = True
                solved = True

                print("You stumble blindly into a solid concrete wall.") # Solved.
    ...
    if not solved:
        print("you have failed me.") # Did not reach the end.
